...
<html>
    ...
    <div class="w3-bar w3-blue">
            ...
            <div class="w3-row">
                ...
                <div class="w3-col m5">
                    <form method='POST' action='tpengguna.php'>
                    <?php
                        echo "<div class='w3-margin-left'>
                        <div class='w3-container'>
                        <h3 class='w3-bottombar w3-border-pink'>Tambah Pengguna Baru</h3>
                            <table class='w3-table w3-striped'>
                                <tr></tr>
                                <tr>
                                <th>ID Pengguna: <br><span class='w3-text-red'>*4-digit nombor</span></th>
                                <td><input type='text' name='idpengguna' class='w3-input w3-border' pattern='[0-9]{4}' oninvalid='this.setCustomValidity('Sila masukkan 4 digit nombor sahaja.')' oninput='this.setCustomValidity('')' placeholder='9999' required></td>
                                <tr>
                                <th>Nama Pengguna:<span class='w3-text-red'>*</span></th>
                                <td>
                                <input type='text' name='namapengguna' class='w3-input w3-border' required placeholder='Nama Pengguna'>
                                </td>
                                </tr>
                                <th>Kata Laluan: <br><span class='w3-text-red'>*min 8, max 16 aksara</span></th>
                                <td>
                                <input type='password' name='kl' class='w3-input w3-border' required minlength='8' maxlength='16' placeholder='Kata Laluan'>
                                </td>
                                <tr>
                                <th>Taraf Pengguna:<span class='w3-text-red'>*</span></th>
                                <td>
                            ...
                            <td colspan='6'>
                                ...
                                <a href='import.php' class='w3-btn w3-purple'>Tambah Pengguna (Import Data)</a>
                            </td>
                        </div></div>";
                        #Papar borang tambah pengguna baharu
                    ?>
                    </div>
                </div>
        </div>
