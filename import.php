...
<html>
    ...
    <div class="w3-bar w3-blue">
            ...
            <div class="w3-row">
                ...
                <div class="w3-col m5">
                <form method='POST' action='timport.php' class="w3-form" enctype="multipart/form-data">
                <div class='w3-margin-left'>
                        <div class='w3-container'>
                        <h3 class='w3-bottombar w3-border-pink'>Tambah Pengguna Baru (Import)</h3>
                            <table class='w3-table w3-striped'>
                                <label>Import file: </label><span class="w3-text-red"> *Masukkan banyak data pada masa yang sama</span>
                                <input type="file" name="importfile" class="w3-input w3-border" required>
                                <br>
                            </form>
                            </table>
                            <td colspan='6'>
                                <button type='submit' class='w3-btn w3-blue'>Hantar</button>
                                <button type='reset' class='w3-btn w3-red'>Reset</button>
                                <a href='penggunabaru.php' class='w3-btn w3-purple'>Tambah Pengguna (Borang)</a>
                                <p><b>Perhatian*</b></p>
                                <p><u>Garis Panduan Import Data Pengguna</u></p>
                                <p>1. Data pengguna yang banyak boleh dimasukkan.</p>
                                <p>2. Sila menambah data pengguna mengikut format:</p>
                                <p><b>(a) </b>ID Pengguna mesti <b>4</b> nombor sahaja. Jika ID Pengguna yang dimasukkan sudah wujud, tidak diterima.</p>
                                <p><b>(b) </b>Kata Laluan mesti dalam julat <b>8-16</b> aksara sahaja.</p>
                                <p><b>(c) </b>Tahap pengguna perlu dinyatakan. Hanya <b>Staf</b> dan <b>Pelanggan</b> diterima.</p>
                                <p><b>(d) </b>Fail mesti dalam bentuk <b>.txt</b> yang boleh dibuka melalui notepad.</p>
                                <p><b>(e) </b>Gunakan <b>#</b> untuk mewakili jarak untuk import data.</p>
                                <p><b>(f) </b>Pastikan semua data diisi dengan <b>lengkap</b> mengikut urutan yang ditunjukkan dalam gambar di bawah.</p>
                                <p>3. Contoh import fail:</p>
                                <img src='image/contohimport1.png'>
                                <img src='image/contohimport2.png'>
                            </td>
                        </div></div>
                    </form>
                    <?php
                        ...
                        if($err == 1){
                            ...
                            echo "<script>alert('ID Pengguna yang dimasukkan telah wujud. Import data gagal.')</script>";
                        }if($err == 3){
                            echo "<script>alert('ID Pengguna yang dimasukkan mesti 4-digit nombor. Import data gagal.')</script>";
                        }if($err == 4){
                            @$kl = $_GET["kl"];
                            echo "<script>alert('Kata laluan yang dimasukkan mesti dalam julat 8-16 aksara sahaja. Import data gagal.')</script>";
                        }if($err == 5){
